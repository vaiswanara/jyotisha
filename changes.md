17-06-2026
- Added a `maxHeight: "280px"` scroll wrapper to the Panchanga search results table in both `PanchangaSearch.jsx` and `PanchangaPage.jsx` to display approximately 5 rows by default and allow scrolling.
